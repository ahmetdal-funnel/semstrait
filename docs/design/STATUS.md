...
- Id-first identity rework (item U) — spec landed in `32`/`18` + cascades; pending: reconcile first-match-wins / `RelationshipId` allocation (`16 §11`, `18 §2.1`) and Unionset/Grainset child order (`22 §3.1`, `23 §3.1`) to the new name-ordered basis.
