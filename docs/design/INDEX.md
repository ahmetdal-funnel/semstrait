...
| `SemanticGraph`, `GraphFragment`, `SegmentKey`, `CoverageMask` (canonical graph type system) | [`apis/35_semstrait_ir.md`](apis/35_semstrait_ir.md) |
| Runtime graph segment lifecycle (`GraphSegmentStore`, `GraphSegmentBuilder`, drift policy) | [`apis/34_semstrait_planner.md`](apis/34_semstrait_planner.md) §1.4A |
...
| Semantic expression seed flow (`ExprBank`, dependency harvesting, runtime realization boundary) | [`foundations/19_expression_flow.md`](foundations/19_expression_flow.md), [`apis/33_semstrait_manifest.md`](apis/33_semstrait_manifest.md) §3 |
...
| `ExprBank` + `SemanticExprSeed` (manifest storage shape) | [`apis/33_semstrait_manifest.md`](apis/33_semstrait_manifest.md) §3.3 |
