...
| --- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| A   | Identity           | `body.base.name` (Public form: globally unique across top-level `data_kinds:` per SR-3; Nested form: scoped to parent's nested-kind scope per `26 §4`).                                                                                                                                                                                                                                                    | `data_kind_id` for explicit Unionsets (compile-assigned per `33 §<DataKindId>`); `data_kind_id` for **implicit** Unionsets (a stable content-derived hash of the parent `Dataset`'s structural identity + per-source list, per `33 §<implicit-unionset-id>`, both forthcoming). Implicit Unionsets carry no `name`. | `32 §3.1`, `32 §3.3`, `26 §4`, `21 §3.2` |
