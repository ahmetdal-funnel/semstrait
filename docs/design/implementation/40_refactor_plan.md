...
# 40. Refactor Plan — Stub

> **Status: Stub.** This document is a placeholder.
>
> The refactor plan from current code to the ratified design will be authored **only after design completion** — when every open question in `foundations/`, `data-kinds/`, and `apis/` is resolved and every spec rule is ratified.
>
> Until then, do not draft refactor steps here. References from other design docs that point at this file (e.g. "tracked in `implementation/40_refactor_plan.md`") remain valid as forward-looking pointers; the content lands once design closes.
>
> Companion stubs:
>
